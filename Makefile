...
python-quality: invariants lint architecture structure codex-protocol unwired-claims prose-references gate-coverage health-claims order-directives override-locks typecheck ## Run Python tests on Postgres with coverage enforcement
