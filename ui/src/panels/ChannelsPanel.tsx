...
// The webhook-class platforms the backend accepts (channel_connect validates).
const PLATFORM_OPTIONS = [
  { value: "webhook", label: "Webhook" },
  { value: "msteams", label: "MS Teams" },
];

// The channel's behaviour for an unbound sender (channel_routes: reject default,
// ignore silently, or issue a pairing code).
...
// The role tiers a pairing / binding may grant (channel_gateway.CHANNEL_TIERS).
const ROLE_OPTIONS = [
