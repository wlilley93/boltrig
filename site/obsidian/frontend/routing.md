...
a **Server Component**; the client-only WebGL scene is isolated in a leaf
(`components/brain/` → `BrainCanvas`) — see [[component-conventions]] hard
rule #6 and [[decisions-log]] ADR-0013.
