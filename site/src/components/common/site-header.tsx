...
/**
 * Persistent site header — the Boltrig wordmark (left, scrolls to the top) and a
 * standing "Open console" call to action (right, -> the governed console). Fixed
 * over the scene so branding and conversion are always in reach, not only at the
 * finale. Springs the whole bar in on first paint (rule #1). The telemetry status
 * bar lives at the foot of the viewport, so the top is the header's alone.
 */
