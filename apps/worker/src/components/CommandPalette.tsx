...
export const workerCommands: Command[] = [
  ...
  { route: "settings", routeId: "models", label: "Models settings", description: `Choose the models ${productName()} may use`, keywords: "llm text vision voice routes", hint: "Settings" },
