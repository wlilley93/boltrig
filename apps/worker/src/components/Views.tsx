...
export function SettingsView() {
  return (
    <div className="page">
      <Topbar title="Settings" status={isDesktop ? "Desktop" : "Browser"} />
      <div className="page-content settings-grid">
        ...
        <section className="settings-card">
          ...
          <p>Signing out revokes the current browser session cookie. Other sessions remain visible and revocable in Account.</p>
