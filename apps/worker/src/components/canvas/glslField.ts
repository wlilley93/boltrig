// The curl-noise FIELD chunk, split out of glslCommon when that file passed the
// 400-line structural floor (NFR-MNT-07). It stays a single string for the
// reason the glslCommon header gives: the simulation and the draw pass must
// walk the SAME curl(p), and they can only do that by sharing this text.
