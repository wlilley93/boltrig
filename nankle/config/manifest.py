...
_BUILTIN_MODULES: dict[str, str] = {
    "ms-graph": "nankle.adapters.builtin.ms_graph",
    "jira": "nankle.adapters.builtin.jira",
    "crm-sql": "nankle.adapters.builtin.crm_sql",
    "memory-tickets": "nankle.adapters.builtin.memory_tickets",
}
