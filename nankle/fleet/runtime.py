...
if TYPE_CHECKING:  # avoid importing the model record at runtime; keep it a seam
    from nankle.models import AgentCapability, ModelEndpoint
...
class HermesRuntime:
    ...
    runtime = "hermes"
    _KEY_ENVS = ("NANKLE_HERMES_API_KEY", "HERMES_API_KEY")
...
class ClaudeApiRuntime:
    ...
    runtime = "claude-api"
    _KEY_ENVS = ("ANTHROPIC_API_KEY", "NANKLE_ANTHROPIC_API_KEY")
