...
from nankle.models import ConversationMessage, MessageRole
...
def continuity_enabled() -> bool:
    """Continuity is config-as-data (P7): on by default, ``NANKLE_CONTINUITY=0``
    restores the prior single-message behaviour exactly."""
    return os.environ.get("NANKLE_CONTINUITY", "1") != "0"
